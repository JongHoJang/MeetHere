...
const Footer = async () => {
  return (
    <footer className="bottom-0 left-0 right-0 py-4 bg-[#333] text-white z-50 md:fixed md:py-10">
      <div className="w-full max-w-web-main mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-2">
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-5 text-sm text-center">
          <a
            href="https://..."
